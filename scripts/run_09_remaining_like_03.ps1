...
$expRoot = 'D:\软件\eclipse\workspace\TransportationProcurement\analysis\巴西数据分析\新版_purchase时间\输出\09_lambda超大值延伸分析_k=1\01_原始求解目录'
$logRoot = 'D:\软件\eclipse\workspace\TransportationProcurement\analysis\巴西数据分析\新版_purchase时间\输出\09_lambda超大值延伸分析_k=1\runlog'
...
Append-State 'RUN_START_09_REMAINING'
...
if ($jobs.Count -gt 0) {
  Run-Jobs $jobs
  Append-State 'ALL_DONE_09_REMAINING'
} else {
